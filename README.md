...
![SpeedBoard](doc/images/screenshot-pb-b-1.png)
...
- Windows
- MacOS
- iOS and iPadOS buildable, but not available as downloadable packages
...
- Track detection
- Save the best, median, last or all laps to a file
