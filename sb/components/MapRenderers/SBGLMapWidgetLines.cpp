#include "sb/components/MapRenderers/SBGLMapWidgetLines.h"
...
void SBGLMapWidgetLines::initializeGL()
{
...
void SBGLMapWidgetLines::resizeGL(int w, int h)
{
    if (w > h)
    {
...
void SBGLMapWidgetLines::paintGL()
{
    if (!m_initialized)
    {
        return;
